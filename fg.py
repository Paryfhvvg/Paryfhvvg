...
CHANNELS_FILE = '145channels.json'
VPN_KEYS_FILE = '145vpn_keys.json'
USERS_FILE = '145users.json'
...
def send_welcome(message):
    ...
    for channel in channels:
        ...
        keyboard.add(types.InlineKeyboardButton(f" {channel['name']}", url=full_url))
