...
CHANNELS_FILE = '17channels.json'
VPN_KEYS_FILE = '17vpn_keys.json'
USERS_FILE = '17users.json'
...
def send_welcome(message):
    ...
    for channel in channels:
        ...
        display_name = escape_markdown(channel['name'])  # Экранируем имя для отображения
        try:
...
def process_broadcast_inline(message):
    ...
    keyboard.add(
        ...
        types.InlineKeyboardButton("❌ Ýatyrl", callback_data="cancel_action")
    )
    bot.send_message(
        message.chat.id,
